...
void SimonKeySetup64(unsigned char* rk, unsigned int* rkexp)
{
	int mm = 3; 
	int nn = 32; 
	int i, j = 0;
...
void SimonEncrypt64(uint32_t *SR, uint32_t *SL, uint32_t *k)
{
...
void SimonEncrypt96(uint64_t *SR, uint64_t *SL, uint64_t *k)
{
...
void SimonEncrypt128(uint64_t *SR, uint64_t *SL, uint64_t k[])
{
	uint64_t i;
