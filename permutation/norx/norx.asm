...
; 52   :     int      i, j, idx;
; 53   :     uint32_t a, b, c, d;
; 54   :     norx_word_t *s=(norx_word_t*)state;
; 55   :     
; 56   :     uint16_t idx16[8]=
...
; 57   :     { 0xC840, 0xD951, 0xEA62, 0xFB73,    // column index
; 58   :       0xFA50, 0xCB61, 0xD872, 0xE943 };  // diagnonal index
; 59   :     
; 60   :     for (i=0; i<NORX_L; i++) {

	sub	DWORD PTR tv611[esp+36], 1
	jne	$LL4@norx_permu
	pop	edi
	pop	esi
	pop	ebp
