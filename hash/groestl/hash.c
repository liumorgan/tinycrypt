...
/*
 * 8 bit implementation of the hash function Groestl 256. Designed for avr micro-controllers.
 * This implementation of Groestl 256 is coded by Morten Skovbjerg Ipsen (mipsen@gmail.com).
 * December 04, 2011.
 */
